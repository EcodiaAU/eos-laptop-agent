...
async function handle() {
  throw new Error(
    'gmail-send is a Phase 1 stub. Run record-mode against the live UI with Tate present (or have Tate execute the flow once with the screen recorder running) to capture real selectors/coords. See ~/ecodiaos/patterns/macros-record-mode-and-auto-author-from-runs.md.'
  );
}

module.exports = {
  name: 'gmail-send',
  description: 'Gmail Send - STUB. Requires Phase 2 record-mode pass before dispatch.',
