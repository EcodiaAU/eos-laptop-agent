...
async function handle() {
  throw new Error(
    'supabase-dashboard is a Phase 1 stub. Run record-mode against the live UI with Tate present (or have Tate execute the flow once with the screen recorder running) to capture real selectors/coords. See ~/ecodiaos/patterns/macros-record-mode-and-auto-author-from-runs.md.'
  );
}

module.exports = {
  name: 'supabase-dashboard',
  description: 'Supabase Dashboard - STUB. Requires Phase 2 record-mode pass before dispatch.',
